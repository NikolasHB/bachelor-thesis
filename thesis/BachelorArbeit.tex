...
\begin{tabularx}{\linewidth}{@{}>{\bfseries}p{0.2\textwidth}@{\hspace{.5em}}X@{}}
	...
	SEF			&	Software Engineering Framework; ein Regelwerk der Commerzbank mit verschiedensten Vorgaben zur Softwareentwicklung \\
...
\begin{tabularx}{\linewidth}{@{}>{\bfseries}p{0.2\textwidth}@{\hspace{.5em}}X@{}}
	...
	iFrame			&	Ein HTML-Element zur Einbettung eigenständiger Dokumente. \\
	jQuery			&	Eine JavaScript-Bibliothek für DOM-Manipulation, Event-Handling und Animation. \\
	...
	WebSocket		&	Eine bidirektionale Erweiterung von HTTP. \\
	Whitebox-Test	&	Ein Test, welcher unter Kenntniss der inneren Funktionsweise entwickelt wird. \\
