...
\begin{enumerate}[label=\textbf{A\arabic*}]
	...
	\item Sie soll aktiv gewartet und Fehler in ihr behoben werden; es soll eine aktive Open-Source-Community vorhanden sein.
...
Für die Entscheidungsfindung wird eine Entscheidungsmatrix (s. Tabelle \ref{tbl:entscheidungsmatrix}) erstellt, in welcher die Anforderungen gegen die gefundene Software abgeglichen werden. Ein grüner Haken steht für ein Erfüllen der Anforderung; ein rotes Kreuz für einen Widerspruch. Eine leere Zelle bedeutet, dass die Anforderung bei dieser Software nicht relevant ist, da sie weder positiv noch negativ beeinträchtigt wird. Eine Anforderung wird von der ausgewählten Softwaremenge erfüllt, wenn keine Einzelsoftware der Anforderung widerspricht.\todo{Formulierung!!!}

Wie in Abschnitt \ref{sec:anforderungsanalyse} bereits beschrieben werden zur Erfüllung von Anforderung A1 ein Testrunner, ein Testframework sowie eine Assertion-Bibliothek benötigt; zur Erfüllung von Anforderung A2 zusätzlich ein Tool zur Browsersteuerung. Hierzu werden die gefundenen Softwares kategorisiert. Die endgültig ausgewählte Softwaremenge muss mindestens ein Exemplar jeder Kategorie enthalten, damit die Anforderungen A1 und A2 erfüllt werden.
