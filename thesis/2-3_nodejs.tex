...
\begin{itemize}
	...
	\item \glqq test\grqq~ führt das Kommando \texttt{mocha [...]} aus. Mocha ist ein Test-Runner (siehe auch \todo{Referenz, Quelle}).
\end{itemize}
